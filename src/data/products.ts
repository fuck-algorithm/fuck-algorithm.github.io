...
export const products: Product[] = [
  {
    ...
    longDescription: '收集了LeetCode平台上最受欢迎的100道算法题目，涵盖了从简单到困难的各种难度。每道题目都提供了详细解析，包括解题思路、算法分析和多种编程语言的代码实现。',
  ...
  },
  {
    ...
    longDescription: '通过交互式动画展示各种数据结构（如数组、链表、树、图等）的基本操作，帮助你直观理解数据结构的工作原理。非常适合初学者学习数据结构概念。',
